...
%Ii is crucial for military surveillance systems to have a very low possibility of being detected and intercepted. 
%Miniaturization makes sensor devices hard to detect physically; 
%however,
%RF signals can be easily intercepted if sensor devices actively communicate during the surveillance stage. 
%A zero communication exposure is desired in the absence of significant events.
